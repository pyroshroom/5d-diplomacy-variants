...
const regions: { [id: string]: Region } = {
  ...
  Ank: { x: 770, y: 190, type: RegionType.Coast, isSupplyCentre: true },
  ...
  Ber: { x: 430, y: 465, type: RegionType.Coast, isSupplyCentre: true },
  BLA: { x: 755, y: 255, type: RegionType.Sea },
  Boh: { x: 445, y: 380, type: RegionType.Land },
  BOT: { x: 530, y: 585, type: RegionType.Sea },
  Bre: { x: 205, y: 375, type: RegionType.Coast, isSupplyCentre: true },
  ...
  Con: { x: 675, y: 170, type: RegionType.Coast, isSupplyCentre: true },
  ...
  Mar: { x: 285, y: 280, type: RegionType.Coast, isSupplyCentre: true },
  Mos: { x: 800, y: 540, type: RegionType.Land, isSupplyCentre: true, homeNation: Nation.Russia },
  Mun: { x: 380, y: 375, type: RegionType.Land, isSupplyCentre: true },
  ...
  Par: { x: 250, y: 365, type: RegionType.Land, isSupplyCentre: true },
  ...
  Smy: { x: 750, y: 120, type: RegionType.Coast, isSupplyCentre: true },
  ...
  Stp_S: { x: 625, y: 595, type: RegionType.Coast, homeNation: Nation.Russia },
  Swe: { x: 470, y: 640, type: RegionType.Coast, isSupplyCentre: true },
  Syr: { x: 870, y: 85, type: RegionType.Coast },
  Tri: { x: 470, y: 265, type: RegionType.Coast, isSupplyCentre: true, homeNation: Nation.Italy },
